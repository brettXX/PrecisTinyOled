...
class PrecisTinyOled
{
  public:
    ...
    void number(byte x, byte y, const char * n, byte iconSize, bool clr);
  ...
  private:
    ...
    void _stream(byte com, byte mode);
    ...
    int _charPos(const char * haystack, char needle, byte startPos);
